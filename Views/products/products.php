        ...
        <div class="cs_shop_filter">
            ...
            <div class="cs_filter_sidebar">
                ...
                <div class="cs_filter_sidebar_in">
                    <!-- Tìm kiếm sản phẩm -->
                    <form class="cs_header_search_form" method="post" action="?act=products">
                        <input type="text" placeholder="Tìm Kiếm..." name="timkiem" value="<?= isset($kyw) ? ($kyw) : '' ?>">

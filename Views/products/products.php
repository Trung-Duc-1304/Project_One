...
<!-- Mirrored from static.laralink.com/html/sattiyas/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Mar 2024 15:05:58 GMT -->
...
<body>
            ...
            <div class="container-fluid">
                <div class="cs_top_header_in">
                    <div class="cs_top_header_left">
                        <p class="cs_medium mb-0">Support : <a href="https://static.laralink.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3242405d5647514672415346465b4b53411c515d5f">[email&#160;protected]</a></p>
                    </div>
                        ...
                        <div class="cs_nav cs_medium">
                            <ul class="cs_nav_list">
                                ...
                                <li class="menu-item-has-children">
                                    <a href="index.php?act=products.php">Product</a>
                                    <ul>
    ...
    <!-- End header -->
    <!-- Start Page Heading -->
    <section class="cs_page_heading text-center position-relative cs_bg_filed" data-src="assets/client/img/shop_bg.jpg">
    ...
    <section>
        <div class="cs_height_140 cs_height_lg_80"></div>
        <div class="container-fluid">
            <div class="cs_shop_filter">
                <div class="cs_filter_overlay"></div>
                <button class="cs_filter_close">X</button>
            ...
            <div class="cs_filter_sort">
                <div class="cs_filter_sidebar_heading cs_medium">
                    <div class="cs_filter_sidebar_heading_in cs_filter_btn">
                        <svg width="20" height="12" viewBox="0 0 20 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cs_product_grid cs_product_grid_4 cs_grid_view">
                <?php foreach($load_all_sp as $loadsp): extract($loadsp) ?>
                <div class="cs_product_col">
                    <div class="cs_product cs_style_1">
                        <div class="cs_product_thumb position-relative">
                            ...
                            <a href="cart.html" class="cs_cart_btn cs_accent_bg cs_fs_16 cs_white_color cs_medium position-absolute">Thêm Vào Giỏ Hàng</a>
                        </div>
                        <div class="cs_product_info text-center">
                            ...
                            <p class="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium"><?= $giasp?> VND</p>
                            ...
                            <div class="cs_action_btns">
                                <a href="#" class="cs_btn cs_style_1 cs_fs_16 cs_medium cs_accent_btn">Thêm Vào Giỏ Hàng</a>
                ...
                <div class="row">
                    <div class="col-xxl-3 col-lg-3">
                        <div class="cs_footer_widget cs_text_widget">
                            ...
                            <img src="assets/client/img/payment_method.svg" alt="Payment">
                        </div>
                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="cs_footer_widget cs_menu_widget">
                                    ...
                                    <ul class="cs_contact_info">
                                        ...
                                        <li>Email : <a href="https://static.laralink.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e78e898188a7948693938e9e8694c984888a">[email&#160;protected]</a></li>
...
<!-- Mirrored from static.laralink.com/html/sattiyas/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Mar 2024 15:06:46 GMT -->

...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="https://img.logoipsum.com/296.svg"> <!-- Fonts -->
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <div class="app-brand demo ">
          <a href="index.php?act=home" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">𝒇𝒂𝒔𝒉𝒊𝒐𝒏</span>
          </a>
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-header small text-uppercase">
            <span class="menu-header-text" data-i18n="𝑨𝒑𝒑𝒔 & 𝑷𝒂𝒈𝒆𝒔">𝑨𝒑𝒑𝒔 &amp; 𝑷𝒂𝒈𝒆𝒔</span>
          </li>
          <!-- e-commerce-app menu start -->
          <li class="menu-item">
            <a href="index.php?act=list_dm" class="menu-link">
              <i class='menu-icon tf-icons bx bxs-category'></i>
              <div class="text-truncate" data-i18n="𝑸𝒖𝒂̉𝒏 𝑳𝒚́ 𝑫𝒂𝒏𝒉 𝑴𝒖̣𝒄">𝑸𝒖𝒂̉𝒏 𝑳𝒚́ 𝑫𝒂𝒏𝒉 𝑴𝒖̣𝒄</div>
            </a>
          </li>
          <!-- e-commerce-app menu end -->
          <!-- Academy menu start -->
          <li class="menu-item">
            <a href="index.php?act=list_sp" class="menu-link">
          ...
          <li class="menu-item">
            <a href="?act=list_account" class="menu-link">
              <i class='menu-icon tf-icons bx bx-user'></i>
              <div class="text-truncate" data-i18n="𝑸𝒖𝒂̉𝒏 𝑳𝒚́ 𝑻𝒂̀𝒊 𝑲𝒉𝒐𝒂̉𝒏">𝑸𝒖𝒂̉𝒏 𝑳𝒚́ 𝑻𝒂̀𝒊 𝑲𝒉𝒐𝒂̉𝒏</div>
            </a>
          </li>

          <li class="menu-item">
            <a href="?act=thongke_ngay" class="menu-link">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                  ...
                  <?php $Count_order = Count_order(); ?>
                  <span class="badge bg-danger rounded-pill badge-notifications"><?= $Count_order['total_orders'] ?></span>
                </a>
                <ul class="dropdown-menu dropdown-menu-end py-0">
                  <li class="dropdown-menu-header border-bottom">
                    <div class="dropdown-header d-flex align-items-center py-3">
                      <h5 class="text-body mb-0 me-auto">Đơn hàng</h5>
                      <a href="javascript:void(0)" class="dropdown-notifications-all text-body" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark all as read"><i class="bx fs-4 bx-envelope-open"></i></a>
                    </div>
                  </li>
                  <li class="dropdown-notifications-list scrollable-container">
                    <ul class="list-group list-group-flush">
                      <?php $list_order_home = list_order_home(); ?>
                      <?php foreach ($list_order_home as $notifications) :
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="../uploads/<?= $image ?>" alt class="w-px-40 h-auto rounded-circle">
                              </div>
                            </div>
                            <div class="flex-grow-1">
                              <h6 class="mb-1"><?= $hovaten ?> 🎉</h6>
                              <p class="mb-0"><?= $tensp ?></p>
                  ...
                  <li>
                    <a class="dropdown-item" href="pages-account-settings-account.html">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <span class="fw-medium d-block">𝒇𝒂𝒔𝒉𝒊𝒐𝒏</span>

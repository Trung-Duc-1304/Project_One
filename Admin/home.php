      ...
      <div class="col-lg-6 col-md-3 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <span class="d-block">Việc bán hàng</span>
  ...
  <div class="col-md-6 col-lg-4">
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between">
          <small class="text-muted">Bạn đã làm <span class="fw-medium">57.6%</span> bán hàng nhiều hơn.<br>Kiểm tra huy hiệu mới trong hồ sơ của bạn.</small>
          <div>

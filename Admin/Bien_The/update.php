...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Biến Thể /</span><span> Cập Nhật</span>
    </h4>

    <div class="app-ecommerce">
        <form action="index.php?act=update_bt&pro_id=<?=$pro_id?>&id=<?=$id?>" method="post">
            <!-- Add Product -->
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex align-content-center flex-wrap gap-3">
                    ...
                    <a href="index.php?act=list_bt&id=<?=$pro_id?>" class="btn btn-label-primary"> Danh Sách</a>
                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-tile mb-0">Thông Tin Biến Thể</h5>
                        </div>
                        <div class="card-body">
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col"><label class="form-label" for="ecommerce-product-sl">Số Lượng</label>
                                    <input type="number" class="form-control" id="ecommerce-product-sl" placeholder="Số lương" value="<?=$soLuong ?>" min="1" name="soLuong" aria-label="Product soluong">
                                </div>

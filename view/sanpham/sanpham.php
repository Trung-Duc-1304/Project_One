        ...
        <div class="container-fluid">
              ...
              <defs>
                ...
                <div class="cs_sort_section">
                    ...
                    <div class="cs_sort_wrap">
                        <div class="cs_sort">
                            <select>
                <option selected>Sắp xếm thời gian mới nhất</option>
                <option value="1">Sắp xếp giá thấp nhất</option>
            ...
            <ul class="cs_pagination cs_fs_21 cs_semibold cs_mp0">
                <?php for($i=1;$i<=$page;$i++){ ?>
                        <li class=" cs_page_item <?php echo (($hihi == $i) ? 'active' : '')?>"><a class="cs_page_link" href="?act=sanpham&page=<?php echo $i?>"><?php echo $i ?></a></li>
                <?php }?>

            ...
            <div class="swiper-wrapper">
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        <img src="../uploads/slider1.png" alt="Slider Image" />
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="product-wrap" >
                        ...
                        <div class="product-content">
                            <h3><a href="?act=chitietsp">Áo Thun Tay Lỡ Yes</a></h3>
                            <div class="product-price">
                                <span class="new-price">150000₫</span>
                                <span class="old-price">180000₫</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="product-content">
                                <h3><a href="?act=chitietsp">Áo Hoodie</a></h3>
                                <div class="product-price">
                                    <span class="new-price">3000000₫</span>
                                    <span class="old-price">2500000₫</span>
                                </div>
                            </div>
                        </div>
                    </div>

<div class="cs_height_80 cs_height_lg_80"></div>
                ...
                <div class="cs_slider_wrapper">
                        ...
                        <div class="cs_hero cs_style_2 position-relative">
                            <div class="cs_hero_left">
                                <div class="cs_hero_text">
                                    <h4 class="cs_hero_title_mini cs_fs_28">Khuyến mãi lên tới 50%</h4>
                                    <h1 class="cs_hero_title cs_fs_67 cs_bold">Bộ sưu tập áo Thun thanh lịch trong mùa hè</h1>
                                    <a href="?act=spdanhmuc&id=1" class="cs_btn cs_style_1 cs_fs_16 cs_medium">Xêm bộ sưu tập</a>
                                </div>
                            </div>
                            <div class="cs_hero_right">
                                <div class="cs_hero_thumb"><img src="../assets/img/hero2.jpg" alt="Thumb"></div>
                    ...
                    <div class="slick_slide_in">
                        <div class="cs_hero cs_style_2 position-relative">
                            <div class="cs_hero_left">
                                <div class="cs_hero_text">
                                    <h4 class="cs_hero_title_mini cs_fs_28">Khuyến mãi lên đến 20%</h4>
                                    <h1 class="cs_hero_title cs_fs_67 cs_bold">Bộ sưu tập áo Sweater thanh lịch trong mùa hè</h1>
                                    <a href="?act=spdanhmuc&id=4" class="cs_btn cs_style_1 cs_fs_16 cs_medium">Xem bộ sưu tập</a>
                                </div>
                            </div>
                            <div class="cs_hero_right">
                                <div class="cs_hero_thumb"><img src="../assets/img/hero5.jpg" alt="Thumb"></div>
                                <div class="cs_animated_text position-absolute">
                                    <img src="../assets/img/animated_text.png" alt="Text Image">
                                    <span class="cs_text_light cs_accent_bg"></span>
                                </div>
                    ...
                    <div class="slick_slide_in">
                        <div class="cs_hero cs_style_2 position-relative">
                            <div class="cs_hero_left">
                                <div class="cs_hero_text">
                                    <h4 class="cs_hero_title_mini cs_fs_28">Khuyến mãi lên đến 10%</h4>
                                    <h1 class="cs_hero_title cs_fs_67 cs_bold">Bộ sưu tập áo Hoodie mùa đông</h1>
                                    <a href="?act=spdanhmuc&id=2" class="cs_btn cs_style_1 cs_fs_16 cs_medium">Xem bộ sưu tập</a>
                                </div>
                            </div>
                            <div class="cs_hero_right">
                                <div class="cs_hero_thumb"><img src="../assets/img/hero6.jpg" alt="Thumb"></div>
                                <div class="cs_animated_text position-absolute">
                                    <img src="../assets/img/animated_text.png" alt="Text Image">
                                    <span class="cs_text_light cs_accent_bg"></span>
                                </div>
    ...
    <div class="row cs_gap_y_24">
        <div class="col-sm-6">
            <div class="cs_category cs_style_1">
                <a href="?act=spdanhmuc&id=1" class="cs_category_thumb position-relative">
                    <img src="../assets/img/men2.jpg" alt="Category Image" class="w-100">
        ...
        <div class="col-sm-6">
            <div class="cs_category cs_style_1">
                <a href="?act=spdanhmuc&id=2" class="cs_category_thumb position-relative">
                    <img src="../assets/img/women2.jpg" alt="Category Image" class="w-100">
                    <span class="cs_category_btn">
            <span>Áo Hoodie</span>
                    <span><i class="fa-solid fa-arrow-right"></i></span>
                    </span>
        ...
        <div class="col-sm-6">
            <div class="cs_category cs_style_1">
                <a href="?act=spdanhmuc&id=4" class="cs_category_thumb position-relative">
                    <img src="../assets/img/kid1.jpg" alt="Category Image" class="w-100">
                    <span class="cs_category_btn">
        ...
        <div class="col-sm-6">
            <div class="cs_category cs_style_1">
                <a href="?act=spdanhmuc" class="cs_category_thumb position-relative">
                    <img src="../assets/img/children2.jpg" alt="Category Image" class="w-100">
                    <span class="cs_category_btn">
            <span>Áo</span>
                    <span><i class="fa-solid fa-arrow-right"></i></span>
                    </span>
    ...
    <section>
        ...
        <div class="container">
            <div class="text-center">
                <h2 class="cs_section_title cs_fs_50 cs_bold mb-0">Sản phẩm mới trong của hàng</h2>
            </div>
            <div class="cs_height_63 cs_height_lg_35"></div>
            <div class="cs_isotope_filter cs_style_1">
                <ul class="cs_mp0">
                    <?php
                        ...
                        // extract($dm);
                        // echo '<a href="?act=spdanhmuc&id='.$id.'">'.$tendm.' </a>';
                        // }
                    ?>
                    <!-- <li><a href="<?php echo $list_sp_aothun;?>" data-filter=".t_shirt .t_shirt1 .hehe" class="cs_fs_16 cs_medium">Tất cả</a></li> -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 align-items-center">
                        <div class="cs_card_info">
                            <h2 class="cs_card_title cs_fs_50 cs_bold">Áo đẹp bốn mùa ưu đãi có hạn 40%</h2>
                            <p class="cs_card_subtitle cs_fs_21 cs_semibold">
                            Cho đến ngày 15/02/24 Sử dụng mã WINTER khi thanh toán
                            </p>
                            <a href="?act=sanpham" class="cs_btn cs_style_1 cs_fs_16 cs_medium">Shop Now</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="cs_gray_bg">
        <div class="cs_height_120 cs_height_lg_70"></div>
        <div class="container">
            <h2 class="cs_section_title cs_fs_50 cs_bold mb-0 text-center">Khách hàng của chúng tôi nói gì ?</h2>
        </div>
                    ...
                    <div class="cs_slider_wrapper">
                        <div class="slick_slide_in">
                            <div class="cs_testimonial cs_style_1 text-center">
                                <blockquote class="cs_testimonial_text cs_fs_21 cs_semibold">Mua sắm tại Sattiyas là một niềm vui tuyệt đối! Tôi đã có vinh dự được trở thành một <br> 
                                khách hàng trong năm qua và tôi có thể tự tin nói rằng đây là hoạt động mua sắm trực tuyến thường xuyên của tôi<br> 
                                điểm đến. Rất khuyến khích!</blockquote>
                                <div class="cs_testimonial_user">
                                    <div class="cs_avatar_thumb">
                                        <img src="../assets/img/user.png" alt="Avatar">
                                    </div>
                                    <h4 class="cs_avatar_title cs_fs_21 cs_semibold mb-0">Nguyễn Kim Kỳ</h4>
                                    <p class="cs_avatar_subtitle mb-0">Việt Nam</p>
                                </div>
                            </div>
                        </div>
                        <div class="slick_slide_in">
        ...
        <div class="container">
            <div class="cs_section_heading cs_style_1">
                <div class="cs_section_heading_in">
                    ...
                    Đọc thời trang độc quyền của chúng tôi <br> trên các bài viết thời thượng</h2>
                </div>
                <div class="cs_hesction_heading_right">
                    <a href="blog.html" class="cs_btn cs_style_1 cs_fs_16 cs_medium">Xem tất cả bài viết</a>
                </div>
            </div>
